...
const requestRide = async (req, res) => {
    try {
        ...
        // ----------------------------------------------------
        // CHECK WHETHER RIDER ALREADY SELECTED
        // ----------------------------------------------------
        ...
        if (
            ...
            return res.status(409).json({
                message:
                    "Unable to request this rider. The booking may already have a rider."
            });
        }
...
const completeCashPayment = async (
    ...
    try {
        ...
        // ----------------------------------------------------
        // IF FARE IS MISSING, RECALCULATE
        // ----------------------------------------------------
        ...
        if (
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    message:
                        "Fare cannot be calculated because valid ride distance is missing."
                });
            }
